  ...
  try {
    ...
    user = await getOTHUBData(query, params)
      ...
      await othubdb_connection.query(
        query,
        ['COMPLETE',user[0].admin_key, url_params.api_key, type, url_params.network, user[0].app_name, url_params.txn_description, null, url_params.ual, null, null, null, null, 0, null],
