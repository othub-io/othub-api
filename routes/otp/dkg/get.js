  ...
  try {
    ...
    user = await getOTHUBData(query, params)
      ...
      await othubdb_connection.query(
        query,
        ['COMPLETE',null, url_params.api_key, type, url_params.network, user[0].app_name, txn_description, null, url_params.ual, null, dkg_get_result.assertionId, null, null, 0, null],
