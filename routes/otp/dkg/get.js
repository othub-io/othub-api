  ...
  try {
    ...
    user = await getOTHUBData(query, params)
      ...
      await othubdb_connection.query(
        query,
        ['COMPLETE',user[0].admin_key, url_params.api_key, type, url_params.network, url_params.app_group, url_params.txn_description, null, url_params.ual, null, dkg_get_result.assertionId, null, null, 0, null],
